...
//            lblTotalRegistros.setText("CANTIDAD DE REGISTROS : " + Integer.toString(funcion.totalRegistros));
    ...
    private void jTablaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTablaMousePressed
         ...
         if (evt.getClickCount() == 2) {
            ...
            String cod , nombre , precio , precio_mayor , stock , precio_compra ;

            cod = jTabla.getValueAt(fila, 0).toString();
            nombre = jTabla.getValueAt(fila, 1).toString();
            precio = jTabla.getValueAt(fila, 4).toString();
            precio_mayor = jTabla.getValueAt(fila, 5).toString();
            stock = jTabla.getValueAt(fila, 7).toString();
            ...
            if (comprobarProducto == 2) {
                ...
                FrmVentaDetalle.txtPrecio_Prod_Mayor.setText(precio_mayor);
                ...
                FrmVentaDetalle.txtDescuentoXP.setEditable(true);
              /*  
                FrmVentaDetalle11.txtCod_producto.setText(cod);
                FrmVentaDetalle11.txtNombre_producto.setText(nombre);
                FrmVentaDetalle11.txtPrecio_producto.setText(precio);
                FrmVentaDetalle11.txtPrecio_Prod_Mayor.setText(precio_mayor);
                FrmVentaDetalle11.txtStockDetalle.setText(stock);
                FrmVentaDetalle11.txtSubPrecioCompra.setText(precio_compra);
                FrmVentaDetalle11.txtCantidadProducto.setEditable(true);
                FrmVentaDetalle11.txtCod_producto.setEditable(false);
                FrmVentaDetalle11.txtCantidadProducto.setText("");
                FrmVentaDetalle11.txtCantidadProducto.requestFocus();
            */    
            }
     ...
     /*   %%%%%%%%% original
        este evento envia los parametros de la tabla productos a los 
        campos de texto del formulario de venta
