 ...
 * @author oscar
 */
public class ASX extends javax.swing.JInternalFrame {
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        try {
            ...
            JasperReport jr = (JasperReport) JRLoader.loadObject(ReportVentasPorFecha.class.getResource("/Reportes/asx.jasper"));
          ...
          //  JasperPrintManager.printReport(jp, true);
            ...
            JasperReport jr = (JasperReport) JRLoader.loadObject(asx.class.getResource("/Reportes/RptProductosVendidos.jasper"));
            Map parametro = new HashMap<String, Date>();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ASX.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
